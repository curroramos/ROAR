...
#include "roar_gokart_msgs/msg/detail/ego_vehicle_control__rosidl_typesupport_fastrtps_c.h"
...
using _EgoVehicleControl__ros_msg_type = roar_gokart_msgs__msg__EgoVehicleControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EgoVehicleControl__ros_msg_type * ros_message = static_cast<const _EgoVehicleControl__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EgoVehicleControl__ros_msg_type * ros_message = static_cast<_EgoVehicleControl__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_roar_gokart_msgs__msg__EgoVehicleControl(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EgoVehicleControl__ros_msg_type * ros_message = static_cast<const _EgoVehicleControl__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _EgoVehicleControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roar_gokart_msgs__msg__EgoVehicleControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roar_gokart_msgs
size_t max_serialized_size_roar_gokart_msgs__msg__EgoVehicleControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _EgoVehicleControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roar_gokart_msgs__msg__EgoVehicleControl(
...
static message_type_support_callbacks_t __callbacks_EgoVehicleControl = {
...
static rosidl_message_type_support_t _EgoVehicleControl__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EgoVehicleControl,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roar_gokart_msgs, msg, EgoVehicleControl)() {
  return &_EgoVehicleControl__type_support;
}
