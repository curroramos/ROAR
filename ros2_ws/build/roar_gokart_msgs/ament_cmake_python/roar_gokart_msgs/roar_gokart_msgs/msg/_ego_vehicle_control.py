...
class Metaclass_EgoVehicleControl(type):
    """Metaclass of message 'EgoVehicleControl'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'roar_gokart_msgs.msg.EgoVehicleControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ego_vehicle_control
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ego_vehicle_control
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ego_vehicle_control
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ego_vehicle_control
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ego_vehicle_control
...
class EgoVehicleControl(metaclass=Metaclass_EgoVehicleControl):
    """Message class 'EgoVehicleControl'."""
