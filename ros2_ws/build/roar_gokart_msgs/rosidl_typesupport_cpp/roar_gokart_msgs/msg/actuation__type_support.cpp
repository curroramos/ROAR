...
static const _Actuation_type_support_symbol_names_t _Actuation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roar_gokart_msgs, msg, Actuation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roar_gokart_msgs, msg, Actuation)),
  }
};
...
{
  return &::roar_gokart_msgs::msg::rosidl_typesupport_cpp::Actuation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roar_gokart_msgs, msg, Actuation)() {
  return get_message_type_support_handle<roar_gokart_msgs::msg::Actuation>();
}
