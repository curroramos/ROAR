...
bool roar_gokart_msgs__msg__actuation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roar_gokart_msgs.msg._actuation.Actuation", full_classname_dest, 41) == 0);
  }
  roar_gokart_msgs__msg__Actuation * ros_message = _ros_message;
  {  // throttle
...
{
  /* NOTE(esteve): Call constructor of Actuation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("roar_gokart_msgs.msg._actuation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Actuation");
